...
const Dashboard = ()=>{
    ...
    return (
        <div className="container pt-4" style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "space-between", textAlign: "center", minWidth: "100%", minHeight: "100vh" }}>
            <Nav />
            <div>
